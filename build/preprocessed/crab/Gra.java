...
public class Gra extends Canvas implements Runnable {
    ...
    public Gra() {
        ...
        try {
            player = Image.createImage("images/crab.png");
            rcar = Image.createImage("images/rcar.png");
            bcar = Image.createImage("images/bcar.png");
        } catch (IOException e) {
            //rób nic
        }
    ...
    protected void paint(Graphics g) {
        try {
            level = Image.createImage("images/level.png");
        } catch (IOException e) {
            g.setColor(0, 0, 0);
        ...
        //ekran porażki
            ...
            g.fillRect(0, 0, getWidth(), getHeight());
            g.setColor(0xffffff);
            g.drawString("Loooooser!!!", getWidth() / 2, getHeight() / 2, Graphics.HCENTER | Graphics.BASELINE);
